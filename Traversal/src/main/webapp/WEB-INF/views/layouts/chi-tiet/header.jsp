...
<!-- Template CSS -->
<link rel="stylesheet" href="<c:url value='../resources/user/css/style-starter.css'/>">
<link rel="stylesheet" href="<c:url value='../resources/user/css/button.css'/>">
<link rel="stylesheet" href="<c:url value='../resources/user/css/register/style_1.css' />">
...
<!-- Theme style -->
<link rel="stylesheet" href="<c:url value='../resources/user/dist/css/adminlte.min.css'/>">
<!-- overlayScrollbars -->
<link rel="stylesheet"
...
<link href='https://css.gg/bee.css' rel='stylesheet'>
<!--//Style-CSS -->
<!-- Template CSS -->
</head>
		...
		<nav class="navbar navbar-expand-lg stroke">
			<h1>
				<a class="navbar-brand"
					href="http://localhost:8080/Traversal/"> Traversal </a>
			</h1>			
			...
			<div class="row">
				...
				<c:if test="${not empty LoginInfo }">
					<div class="col-md-4" style="margin-right:-4px;">
						<h5>
							<a href="dang-xuat">${LoginInfo.display_name}</a>
						</h5>
					</div>				
				</c:if>
				<div class="col-md-1">
