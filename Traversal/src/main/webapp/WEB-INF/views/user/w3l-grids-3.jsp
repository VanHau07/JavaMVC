...
<section class="w3l-grids-3 py-5">
	<div class="container py-md-5">
		<div class="title-content text-left mb-lg-5 mb-4">
			<h6 class="sub-title">CHUYẾN ĐI</h6>
		</div>
			...
			<c:forEach var="item" items="${product}">
				<div class="col-lg-6 subject-card mt-lg-0 mt-4 mb-4">
					<div class="subject-card-header p-4">
						...
						<div class="frame">
							<a href="<c:url value="chi-tiet-san-pham/${item.id }" />"><button class="custom-btn btn-4" href="">Xem
									chi tiết</button></a> <a href="<c:url value="/AddCart/${item.id }"/>"><button
