...
<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header" style="text-align: center;">THÊM BÀI VIẾT</h1>
			</div>
			<!-- /.col-lg-12 --> 
		</div>
		<!-- /.row -->
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading"><marquee>Thêm 1 bài viết nữa vào danh sách</marquee>
					</div>
					<div class="panel-body">
						<div class="row">
							<form:form action="admin_add_blog" method="post"
