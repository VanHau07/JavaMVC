...
<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header" style="text-align: center;">THÊM TOUR
					MỚI</h1>
			</div>
			<!-- /.col-lg-12 -->
		</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<marquee>Thêm 1 tour nữa vào danh sách</marquee>
					</div>
					<div class="panel-body">
						<div class="row">
							<form:form action="admin_add_products" method="post"
								modelAttribute="add" enctype="multipart/form-data">
								<div class="form-row">
									<div class="form-group col-sm-6">
										<label for="myEmail">Tên tour</label>
										<form:input type="text" path="title" class="form-control"
											id="title" placeholder="Tour du lịch ..." />
									</div>
									<div class="form-group col-sm-6">
								...
								<div class="form-row">
									<div class="form-group col-sm-3">
										...
										<form:input type="number" path="price_net" min="0"
											class="form-control" id="price_net" placeholder="0" />
									</div>
									<div class="form-group col-sm-3">
									...
									<div class="form-group col-sm-3">
										...
										<form:input type="number" path="available" min="0"
											class="form-control" id="available" placeholder="0" />
									</div>
									<div class="form-group col-sm-3">
										<label for="myPassword">Đã bán</label>
										<form:input type="number" path="sold" min="0"
											class="form-control" id="sold" placeholder="0" />
									</div>
								</div>
								...
								<div class="form-group">
									<label>Hình ảnh tour:</label> <input type="file"
										name="image_file" id="image_file" class="form-control" />
								...
								<div class="form-row">
									<div class="form-group col-sm-3">
										...
										<form:input type="number" path="id_category"
											class="form-control" id="id_category" min="0" />
									</div>
									<div class="form-group col-sm-6">
									...
									<div class="form-group col-sm-3">
										...
										<form:input type="text" min="0" path="infor"
											class="form-control" id="infor" placeholder="0" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<form:textarea type="text" path="schedule1"
										class="form-control" id="schedule1" placeholder="" />
								</div>
								<div class="form-group">
